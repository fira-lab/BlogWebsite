...
export default function CourseContent(props) {
  ...
  const fetchVideo = async (vid_id) => {
    if (vid_id === 0) {
      ...
      videoURL =
        videoURL + "?id=" + urlParams.get("id") + "&" + "video_id=" + vid_id;
    }
  ...
  async function createComment(text) {
    const data = {
      body: text,
      user_id: user.token.data.id,
      video_id: courseVideo.id,
    };
    axios
      .post(window.apiurl + "create_video_comment.php", data)
      ...
      <div className="main-content">
        <div className="video-section">
          <div className="video-container">
            ...
            <iframe
              src={"https://www.youtube.com/embed/" + courseVideo.url}
            ...
            <ul className="details-nav-tabs">
              <li className="details-nav-tab">
                <a
                  ...
                  onClick={(e) => changeHeaderState(e, 0)}
                >
                  Overview
                </a>
              </li>
              <li className="details-nav-tab">
                <a
                  ...
                  onClick={(e) => changeHeaderState(e, 1)}
                >
                  Q&A
                </a>
              </li>
              <li className="details-nav-tab">
                <a
                  ...
                  onClick={(e) => changeHeaderState(e, 2)}
                >
                  Files
                </a>
              </li>
              <li className="details-nav-tab">
                <a
                  ...
                  onClick={(e) => changeHeaderState(e, 3)}
                >
                  Announcements
                </a>
              </li>
